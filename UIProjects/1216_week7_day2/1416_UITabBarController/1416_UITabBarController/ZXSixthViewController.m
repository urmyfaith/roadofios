...
#import "ZXSixthViewController.h"
#import "ZXAllMethod.h"

@interface ZXSixthViewController ()

@end

@implementation ZXSixthViewController
...
- (void)viewDidLoad
{
    ...
    UILabel *pageLable = [UILabel labelWithFrame:CGRectMake(35,320,250,40)
                                        withText:@"this is the sixth page"
                                         withTag:101
